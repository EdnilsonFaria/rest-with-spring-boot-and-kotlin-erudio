package br.com.ednilsonfaria.rest.security.jwt
...
class JwtTokenProvider {
    ...
    private var validityInMiliseconds: Long = 3_600_000 // Equivalente à 1 hora
    ...
    fun getAuthentication(token: String) : Authentication{
        ...
        val userDetails: UserDetails = userDetailService.loadUserByUsername(decodedJWT.subject)
    ...
    fun validateToken(token: String): Boolean {
        ...
        try{
            if(decodedToken.expiresAt.before(Date())) return false
            return true
        }catch (ex: Exception)
        {
