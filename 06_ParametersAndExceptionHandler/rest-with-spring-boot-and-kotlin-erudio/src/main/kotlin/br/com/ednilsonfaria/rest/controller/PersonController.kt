package br.com.ednilsonfaria.rest.controller

import br.com.ednilsonfaria.rest.data.vo.v1.PersonVO
import br.com.ednilsonfaria.rest.services.PersonService
import br.com.ednilsonfaria.rest.util.MediaType
...
class PersonController {
    ...
    @Operation(summary = "Finds all People", description = "Finds all People",
        tags = ["People"],
        responses = [
            ApiResponse(description = "Success", responseCode = "200", content = [Content(array = ArraySchema(schema = Schema(implementation = PersonVO::class)))]),
